            ...
            <FadeUp>
              <div>
                ...
                <div style={{ display: "flex", gap: 13, marginBottom: 18 }}>
                  ...
                  <p style={{ color: "rgba(255,255,255,0.58)", fontSize: 14, lineHeight: 1.75 }}>SBI ATM Above, Opp-to Kulalar Mandapam , L.F. Road,<br />Cumbum – 625 516,<br />Theni District, Tamil Nadu</p>
                </div>
              ...
              <div style={{
                ...
                <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(2, 1fr)", gap: 24 }}>
                  {[
                    ...
                    { icon: MapPin, label: "Experience Center", value: "SBI ATM Above, Opp-to Kulalar Mandapam, L.F. Road, Cumbum – 625 516", href: "https://maps.app.goo.gl/p5WBtg7MyCHzQNk96" },
